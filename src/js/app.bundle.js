  ...
  var MobileSupport = class {
    ...
    initSwipeGestures() {
      ...
      document.addEventListener("touchstart", (e) => {
        ...
        tracking = this.swipeStartX < this.EDGE_ZONE || document.body.classList.contains("sidebar-mobile-open");
      }, { passive: true });
    ...
    initMobileRibbon() {
      ...
      const actions = [
        { icon: "\u{1F4C1}", action: "explorer", label: "Files" },
        { icon: "\u{1F50D}", action: "search", label: "Search" },
        { icon: "\u{1F4DD}", action: "new-note", label: "New" },
        { icon: "\u{1F4C5}", action: "daily", label: "Daily" },
